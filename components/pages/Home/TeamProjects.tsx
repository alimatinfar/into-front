  ...
  return (
    <HomeContainer id={Ids.projects} className="pt-7 pb-7 md:pt-24 md:pb-14 flex flex-col justify-center items-center space-y-8 md:space-y-12">
      ...
      <div className='relative w-full'>
        ...
        <img src='/images/teamProjects/dargah-project.png' alt='dargah-project.png'/>

        <div className='flex flex-col z-20 md:pr-10 absolute z-20 bottom-2 md:bottom-5 right-2 md:right-5'>
          <p className='font-bold text-lg md:text-2xl lg:text-4xl text-primary'>درگاه ملی حمل بار</p>
          <p className='mt-3 text-sm md:text-base font-light'>سازمان راهداری حمل و نقل جاده‌ای</p>
        </div>
      </div>

      <p className='font-light leading-7 text-justify text-custom-gray-1'>
